...
return{manifest:{about:{name:"Popcorn Attribution Plugin",version:"0.1",author:"@annasob",website:"annasob.wordpress.com"},options:{start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},nameofwork:{elem:"input",type:"text",label:"Name of Work"},nameofworkurl:{elem:"input",type:"text",label:"Url of Work"},copyrightholder:{elem:"input",type:"text",label:"Copyright Holder"},copyrightholderurl:{elem:"input",type:"text",label:"Copyright Holder Url"},license:{elem:"input",
type:"text",label:"License type"},licenseurl:{elem:"input",type:"text",label:"License URL"},target:"attribution-container"}},_setup:function(c){var a="";c._container=document.createElement("div");c._container.style.display="none";if(c.nameofworkurl)a+="<a href='"+c.nameofworkurl+"' target='_blank'>";if(c.nameofwork)a+=c.nameofwork;if(c.nameofworkurl)a+="</a>";if(c.copyrightholderurl)a+="<a href='"+c.copyrightholderurl+"' target='_blank'>";if(c.copyrightholder)a+=", "+c.copyrightholder;if(c.copyrightholderurl)a+=
"</a>";if(a==="")a=c.text;if(c.license)if(b[c.license.toLowerCase()])a=c.licenseurl?"<a href='"+c.licenseurl+"' target='_blank'><img src='"+b[c.license.toLowerCase()]+"' border='0'/></a> "+a:"<img src='"+b[c.license.toLowerCase()]+"' />"+a;else a+=c.licenseurl?", license: <a href='"+c.licenseurl+"' target='_blank'>"+c.license+"</a> ":", license: "+c.license;else if(c.licenseurl)a+=", <a href='"+c.licenseurl+"' target='_blank'>license</a> ";c._container.innerHTML=a;document.getElementById(c.target)&&
document.getElementById(c.target).appendChild(c._container)},start:function(c,a){a._container.style.display="inline"},end:function(c,a){a._container.style.display="none"}}}())})(Popcorn);
(function(f){f.plugin("flickr",{manifest:{about:{name:"Popcorn Flickr Plugin",version:"0.1",author:"Scott Downe",website:"http://scottdowne.wordpress.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},userid:{elem:"input",type:"text",label:"Source"},target:"Flickr-container",height:{elem:"input",type:"text",label:"Height"},width:{elem:"input",type:"text",label:"Width"},padding:{elem:"input",type:"text",label:"Padding"},border:{elem:"input",type:"text",
label:"Border"},numberofimages:{elem:"input",type:"text",label:"Number of Images"}}},_setup:function(b){b.container=document.createElement("div");b.container.style.display="none";document.getElementById(b.target)&&document.getElementById(b.target).appendChild(b.container);var c=b.height||"50px",a=b.width||"50px",d=b.numberofimages||4,e=b.padding||"5px",g=b.border||"0px";$.getJSON("http://api.flickr.com/services/feeds/photos_public.gne?id="+b.userid+"&lang=en-us&format=json&jsoncallback=?",function(i){b.container.innerHTML=
"<p style='padding:"+e+";'>"+i.title+"<p/>";$.each(i.items,function(l,h){if(l<d){var j=document.createElement("a");j.setAttribute("href",h.link);j.setAttribute("target","_blank");var k=document.createElement("img");k.setAttribute("src",h.media.m);k.setAttribute("height",c);k.setAttribute("width",a);k.setAttribute("style","border:"+g+";padding:"+e);j.appendChild(k);b.container.appendChild(j)}else return false})})},start:function(b,c){c.container.style.display="inline"},end:function(b,c){c.container.style.display=
"none"}})})(Popcorn);
(function(f){f.plugin("footnote",{manifest:{about:{name:"Popcorn Footnote Plugin",version:"0.1",author:"@annasob",website:"annasob.wordpress.com"},options:{start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},target:"footnote-container",text:{elem:"input",type:"text",label:"Text"}}},_setup:function(b){b._container=document.createElement("div");b._container.style.display="none";b._container.innerHTML=b.text;document.getElementById(b.target)&&document.getElementById(b.target).appendChild(b._container)},start:function(b,
c){c._container.style.display="inline"},end:function(b,c){c._container.style.display="none"}})})(Popcorn);var googleCallback;
(function(f){f.plugin("googlemap",function(){var b=1,c=false,a=false;return{manifest:{about:{name:"Popcorn Google Map Plugin",version:"0.1",author:"@annasob",website:"annasob.wordpress.com"},options:{start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},target:"map-container",type:{elem:"select",type:"text",label:"Type"},zoom:{elem:"input",type:"text",label:"Zoom"},lat:{elem:"input",type:"text",label:"Lat"},lng:{elem:"input",type:"text",label:"lng"},location:{elem:"input",
type:"text",label:"Location"}}},_setup:function(d){d._newdiv=document.createElement("div");d._newdiv.id="actualmap"+b;d._newdiv.style.width="100%";d._newdiv.style.height="100%";b++;document.getElementById(d.target)&&document.getElementById(d.target).appendChild(d._newdiv);if(!c){c=true;(new Date).getTime();var e=document.getElementsByTagName("head")[0],g=document.createElement("script");g.src="http://maps.google.com/maps/api/js?sensor=false&callback=googleCallback";g.type="text/javascript";e.insertBefore(g,
e.firstChild)}googleCallback=function(){a=true};var i=function(){if(a)if(d.location)(new google.maps.Geocoder).geocode({address:d.location},function(l,h){if(h===google.maps.GeocoderStatus.OK){d.lat=l[0].geometry.location.lat();d.lng=l[0].geometry.location.lng();d._location=new google.maps.LatLng(d.lat,d.lng);d._map=new google.maps.Map(d._newdiv,{mapTypeId:google.maps.MapTypeId[d.type]||google.maps.MapTypeId.HYBRID});d._map.getDiv().style.display="none"}});else{d._location=new google.maps.LatLng(d.lat,
d.lng);d._map=new google.maps.Map(d._newdiv,{mapTypeId:google.maps.MapTypeId[d.type]||google.maps.MapTypeId.HYBRID});d._map.getDiv().style.display="none"}else setTimeout(function(){i()},5)};i()},start:function(d,e){var g=function(){if(e._map){e._map.getDiv().style.display="block";e._map.setCenter(e._location);if(e.zoom&&typeof e.zoom!=="number")e.zoom=+e.zoom;e.zoom=e.zoom||0;e._map.setZoom(e.zoom)}else setTimeout(function(){g()},13)};g()},end:function(d,e){if(e._map)e._map.getDiv().style.display=
"none"}}}())})(Popcorn);
(function(f){f.plugin("googlenews",{manifest:{about:{name:"Popcorn Google News Plugin",version:"0.1",author:"Scott Downe",website:"http://scottdowne.wordpress.com/"},options:{start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},target:"news-container",topic:{elem:"select",type:"text",label:"Type"}}},_setup:function(b){b.container=document.createElement("div");document.getElementById(b.target)&&document.getElementById(b.target).appendChild(b.container);new google.elements.NewsShow(b.container,
{format:"300x250",queryList:[{q:b.topic||"Top Stories"}]});b.container.style.display="none"},start:function(b,c){c.container.setAttribute("style","display:inline")},end:function(b,c){c.container.setAttribute("style","display:none")}})})(Popcorn);
(function(f){f.plugin("image",{manifest:{about:{name:"Popcorn image Plugin",version:"0.1",author:"Scott Downe",website:"http://scottdowne.wordpress.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},href:{elem:"input",type:"text",label:"Link URL"},target:"Image-container",src:{elem:"input",type:"text",label:"Source URL"}}},_setup:function(b){b.link=document.createElement("a");b.link.style.display="none";if(b.href)b.link.href=b.href;b.link.target=
"_blank";document.getElementById(b.target)&&document.getElementById(b.target).appendChild(b.link);var c=document.createElement("img");c.src=b.src;c.style.borderStyle="none";b.link.appendChild(c)},start:function(b,c){c.link.style.display="inline"},end:function(b,c){c.link.style.display="none"}})})(Popcorn);
(function(f){var b=function(c){c||(c=this);for(var a=c.offsetLeft,d=c.offsetTop;c=c.offsetParent;){a+=c.offsetLeft;d+=c.offsetTop}return{left:a,top:d}};f.plugin("lowerthird",{manifest:{about:{name:"Popcorn lowerthird Plugin",version:"0.1",author:"Scott Downe",website:"http://scottdowne.wordpress.com/"},options:{start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},target:"lowerthird-container",salutation:{elem:"input",type:"text",label:"Text"},name:{elem:"input",type:"text",
label:"Text"},role:{elem:"input",type:"text",label:"Text"}}},_setup:function(c){if(!this.container){this.container=document.createElement("div");this.container.style.position="absolute";this.container.style.color="white";this.container.style.textShadow="black 2px 2px 6px";this.container.style.fontSize="24px";this.container.style.fontWeight="bold";this.container.style.paddingLeft="40px";this.container.style.width=this.video.offsetWidth+"px";this.container.style.left=b(this.video).left+"px";this.video.parentNode.appendChild(this.container)}c.container=
c.target&&c.target!=="lowerthird-container"?document.getElementById(c.target):this.container},start:function(c,a){a.container.innerHTML=(a.salutation?a.salutation+" ":"")+a.name+(a.role?"<br />"+a.role:"");this.container.style.top=b(this.video).top+this.video.offsetHeight-(40+this.container.offsetHeight)+"px"},end:function(c,a){a.container.innerHTML=""}})})(Popcorn);
(function(f){var b=function(a){var d,e;d=e=0;if(a.offsetParent){do{d+=a.offsetLeft;e+=a.offsetTop}while(a=a.offsetParent)}return{left:d,top:e}},c=function(a,d){a.selectedLanguage=a.languageSrc.options[a.languageSrc.selectedIndex].value;google.language.translate(d,"",a.selectedLanguage,function(e){a.container.innerHTML=e.translation})};f.plugin("subtitle",{manifest:{about:{name:"Popcorn Subtitle Plugin",version:"0.1",author:"Scott Downe",website:"http://scottdowne.wordpress.com/"},options:{start:{elem:"input",
type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},target:"Subtitle-container",text:{elem:"input",type:"text",label:"Text"}}},_setup:function(a){if(!this.container){this.container=document.createElement("div");this.container.style.position="absolute";this.container.style.color="white";this.container.style.textShadow="black 2px 2px 6px";this.container.style.fontSize="18px";this.container.style.fontWeight="bold";this.container.style.textAlign="center";this.container.style.width=this.video.offsetWidth+
"px";this.container.style.top=b(this.video).top+this.video.offsetHeight-65+"px";this.container.style.left=b(this.video).left+"px";this.video.parentNode.appendChild(this.container)}a.container=a.target&&a.target!=="Subtitle-container"?document.getElementById(a.target):this.container;var d=document.getElementById(a.accessibilitysrc);a.showSubtitle=function(){a.container.innerHTML=a.text};a.toggleSubtitles=function(){};a.that=this;if(a.languagesrc){a.showSubtitle=c;a.languageSrc=document.getElementById(a.languagesrc);
a.selectedLanguage=a.languageSrc.options[a.languageSrc.selectedIndex].value;if(!this.languageSources)this.languageSources={};this.languageSources[a.languagesrc]||(this.languageSources[a.languagesrc]={});if(!this.languageSources[a.languagesrc][a.target]){this.languageSources[a.languagesrc][a.target]=true;a.languageSrc.addEventListener("change",function(){a.toggleSubtitles();a.showSubtitle(a,a.container.innerHTML)},false)}}if(d){a.accessibility=d;a.toggleSubtitles=function(){a.selectedLanguage=a.languageSrc.options[a.languageSrc.selectedIndex].value;
if(a.accessibility.checked||a.selectedLanguage!==(a.language||"")){a.display="inline";a.container.style.display=a.display}else if(a.selectedLanguage===(a.language||"")){a.display="none";a.container.style.display=a.display}};a.accessibility.addEventListener("change",a.toggleSubtitles,false);a.toggleSubtitles()}},start:function(a,d){d.container.style.display=d.display;d.showSubtitle(d,d.text)},end:function(a,d){d.container.style.display=d.display;d.container.innerHTML=""}})})(Popcorn);
(function(f){f.plugin("tagthisperson",function(){var b=[],c=function(){this.name="";this.contains={};this.toString=function(){var a=[],d;for(d in this.contains)this.contains.hasOwnProperty(d)&&a.push(" "+this.contains[d]);return a.toString()}};return{manifest:{about:{name:"Popcorn tagthisperson Plugin",version:"0.1",author:"@annasob",website:"annasob.wordpress.com"},options:{start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},target:"tag-container",text:{elem:"input",
type:"text",label:"Text"}}},_setup:function(a){for(var d=false,e=0;e<b.length;e++)if(b[e].name===a.target){a._p=b[e];d=true;break}if(!d){a._p=new c;a._p.name=a.target;b.push(a._p)}},start:function(a,d){d._p.contains[d.person]=d.person;if(document.getElementById(d.target))document.getElementById(d.target).innerHTML=d._p.toString()},end:function(a,d){delete d._p.contains[d.person];if(document.getElementById(d.target))document.getElementById(d.target).innerHTML=d._p.toString()}}}())})(Popcorn);
(function(f){if(!window.TWTR){var b=document.getElementsByTagName("head")[0]||document.documentElement,c=document.createElement("script");c.src="http://widgets.twimg.com/j/2/widget.js";b.insertBefore(c,b.firstChild)}f.plugin("twitter",{manifest:{about:{name:"Popcorn Twitter Plugin",version:"0.1",author:"Scott Downe",website:"http://scottdowne.wordpress.com/"},options:{start:{elem:"input",type:"number",label:"In"},end:{elem:"input",type:"number",label:"Out"},src:{elem:"input",type:"text",label:"Source"},
target:"Twitter-container",height:{elem:"input",type:"number",label:"Height"},width:{elem:"input",type:"number",label:"Width"}}},_setup:function(a){a.container=document.createElement("div");a.container.setAttribute("id",f.guid());a.container.style.display="none";document.getElementById(a.target)&&document.getElementById(a.target).appendChild(a.container);var d=a.src||"",e=a.width||250,g=a.height||200,i=/^@/.test(d),l=/^#/.test(d),h={version:2,id:a.container.getAttribute("id"),rpp:30,width:e,height:g,
interval:6E3,theme:{shell:{background:"#ffffff",color:"#000000"},tweets:{background:"#ffffff",color:"#444444",links:"#1985b5"}},features:{loop:true,timestamp:true,avatars:true,hashtags:true,toptweets:true,live:true,scrollbar:false,behavior:"default"}},j=function(k){if(window.TWTR)if(i){h.type="profile";(new TWTR.Widget(h)).render().setUser(d).start()}else{if(l){h.type="search";h.search=d;h.subject=d;(new TWTR.Widget(h)).render().start()}}else setTimeout(function(){j(k)},1)};j(this)},start:function(a,
d){d.container.style.display="inline"},end:function(a,d){d.container.style.display="none"}})})(Popcorn);
(function(f){f.plugin("webpage",function(){return{manifest:{about:{name:"Popcorn Webpage Plugin",version:"0.1",author:"@annasob",website:"annasob.wordpress.com"},options:{id:{elem:"input",type:"text",label:"Id"},start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},src:{elem:"input",type:"text",label:"Src"},target:"iframe-container"}},_setup:function(b){b._iframe=document.createElement("iframe");b._iframe.setAttribute("width","100%");b._iframe.setAttribute("height",
"100%");b._iframe.id=b.id;b._iframe.src=b.src;b._iframe.style.display="none";document.getElementById(b.target)&&document.getElementById(b.target).appendChild(b._iframe)},start:function(b,c){c._iframe.style.display="inline"},end:function(b,c){c._iframe.style.display="none"}}}())})(Popcorn);var wikiCallback;
(function(f){f.plugin("wikipedia",{manifest:{about:{name:"Popcorn Wikipedia Plugin",version:"0.1",author:"@annasob",website:"annasob.wordpress.com"},options:{start:{elem:"input",type:"text",label:"In"},end:{elem:"input",type:"text",label:"Out"},lang:{elem:"input",type:"text",label:"Language"},src:{elem:"input",type:"text",label:"Src"},title:{elem:"input",type:"text",label:"Title"},numberofwords:{elem:"input",type:"text",label:"Num Of Words"},target:"wiki-container"}},_setup:function(b){var c,a=f.guid();
if(typeof b.lang==="undefined")b.lang="en";b.numberofwords=b.numberofwords||200;window["wikiCallback"+a]=function(g){b._link=document.createElement("a");b._link.setAttribute("href",b.src);b._link.setAttribute("target","_blank");b._link.innerHTML=g.parse.displaytitle;b._desc=document.createElement("p");c=g.parse.text["*"].substr(g.parse.text["*"].indexOf("<p>"));c=c.replace(/((<(.|\n)+?>)|(\((.*?)\) )|(\[(.*?)\]))/g,"");b._desc.innerHTML=c.substr(0,b.numberofwords)+" ...";b._fired=true};var d=document.getElementsByTagName("head")[0],
e=document.createElement("script");e.src="http://"+b.lang+".wikipedia.org/w/api.php?action=parse&props=text&page="+(b.title||b.src.slice(b.src.lastIndexOf("/")+1))+"&format=json&callback=wikiCallback"+a;d.insertBefore(e,d.firstChild)},start:function(b,c){var a=function(){if(c._fired){if(c._link&&c._desc)if(document.getElementById(c.target)){document.getElementById(c.target).appendChild(c._link);document.getElementById(c.target).appendChild(c._desc);c._added=true}}else setTimeout(function(){a()},13)};
a()},end:function(b,c){if(c._added){document.getElementById(c.target).removeChild(c._link);document.getElementById(c.target).removeChild(c._desc)}}})})(Popcorn);
